    ...
    <div class="container">
        ...
        <div class="table-container">
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.5rem;">
                ...
                <div class="card">
                    ...
                    <a href="system_logs.php" class="btn btn-primary" style="margin-top: 1rem;">View Logs</a>
                </div>
            </div>
        </div>
        ...
        <div class="table-container">
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.5rem;">
                ...
                <div class="form-group">
                    ...
                    <a href="system_logs.php" class="btn btn-primary" style="display: inline-block;">View Logs</a>
                </div>
            </div>
        </div>
        ...
        <div class="card" style="margin-top: 2rem;">
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem;">
                <a href="security_backups.php" class="btn btn-primary" style="display: inline-block; text-align: center;">View Backups</a>
                <a href="security_backups.php" class="btn btn-primary" style="display: inline-block; text-align: center;">Security Settings</a>
